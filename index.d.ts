...
declare module 'bedrock-protocol' {
  ...
  type Version =
    | '1.21.71' | '1.21.70' | '1.21.60' | '1.21.50' | '1.21.42' | '1.21.30' | '1.21.2' | '1.21.0'
    | '1.20.80' | '1.20.71' | '1.20.61' | '1.20.50' | '1.20.40' | '1.20.30' | '1.20.10' | '1.20.0'
    | '1.19.80' | '1.19.70' | '1.19.63' | '1.19.62' | '1.19.60' | '1.19.51' | '1.19.50' | '1.19.41'
    | '1.19.40' | '1.19.31' | '1.19.30' | '1.19.22' | '1.19.21' | '1.19.20' | '1.19.11' | '1.19.10'
    | '1.19.2' | '1.19.1' | '1.18.31' | '1.18.30' | '1.18.12' | '1.18.11' | '1.18.10' | '1.18.2'
    | '1.18.1' | '1.18.0' | '1.17.41' | '1.17.40' | '1.17.34' | '1.17.30' | '1.17.11' | '1.17.10'
    | '1.17.0' | '1.16.220' | '1.16.210' | '1.16.201';

  // Supported localization languages
  type Language =
    | 'en_US' | 'fr_FR' | 'de_DE' | 'es_ES' | 'it_IT' | 'pt_PT' | 'pt_BR'
    | 'zh_CN' | 'zh_TW' | 'ja_JP' | 'ko_KR' | 'ru_RU' | 'ar_SA' | 'hi_IN'
    | 'nl_NL' | 'sv_SE' | 'no_NO' | 'da_DK' | 'fi_FI' | 'pl_PL' | 'tr_TR'
    | 'cs_CZ' | 'el_GR' | 'he_IL' | 'th_TH' | 'vi_VN' | 'id_ID';
  ...
  export interface ClientOptions extends Options {
    ...
    username: string;
    // Minecraft skin and device info
    skinData: skinDataOptions;
    // The view distance in chunks
    viewDistance?: number;
    // Platform the client is using (optional)
  ...
  type ValidateProtocolVersion<P extends ProtocolVersion, V extends Version> =
    V extends ProtocolVersionToVersionMap[P] ? true : false;
}
